    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Database db1=new Database(getApplicationContext(),"Ronit",null,1);
                ...
                else
                {
                        if(confirmpassword.getText().toString().equals(pass)) {
                            if(isValid(pass)){
                                db1.register(name1,email1,pass);
                                Toast.makeText(Registration.this, "Registration Successfull", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(Registration.this,MainActivity.class));
                            }
                            else{
                                Toast.makeText(Registration.this,"Password must contain at least 8 characters,having letter,digit and special characters",Toast.LENGTH_SHORT).show();
                            }
                        }
                        else
                        {
